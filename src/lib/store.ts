...
const seed: AppState = {
  ...
  family: [
    { id: "f1", name: "Anna", relation: "Daughter", emoji: "👩🏼", note: "Lives in Hamburg, visits on Sundays.", birthday: "1978-04-12" },
    { id: "f2", name: "Lukas", relation: "Grandson", emoji: "🧒🏻", note: "Plays football, age 9.", birthday: "2017-09-03" },
    { id: "f3", name: "Peter", relation: "Son", emoji: "👨🏻", note: "Loves gardening together." },
    { id: "f4", name: "Mira", relation: "Granddaughter", emoji: "👧🏽", note: "Paints flowers for Oma." },
  ],
  tasks: [
    { id: "t1", kind: "family-faces", title: "Recognise our family today", assignedBy: "Anna", createdAt: Date.now() - 86400000 },
    { id: "t2", kind: "family-message", title: "Listen to Lukas's hello", detail: "He says: 'Hallo Oma, ich hab dich lieb!'", assignedBy: "Lukas", createdAt: Date.now() - 3600000 },
    { id: "t3", kind: "memory-match", title: "Match the morning tiles", assignedBy: "Peter", createdAt: Date.now() - 7200000 },
  ],
  sessions: [],
};
